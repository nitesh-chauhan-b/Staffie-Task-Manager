...
public class Verify_manager_email extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_verify_manager_email, container, false);
        ...
        String admin_name = b.getString("mng_name");
        String admin_mail = b.getString("mng_email");
