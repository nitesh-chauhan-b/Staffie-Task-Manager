...
public class ManagerAssignedTask_Edit extends Fragment {
    ...
    ArrayList<EmployeeDetails> emp_list;
    String task_ref;
    LinearLayout adding_layout, adding_layout2, adding_layout3;
    ArrayList<java.lang.String> prev_mngs, real_list,added_mng_list,db_prev_list;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_manager_assigned_task__edit, null);
        ...
        edit_task_name = v.findViewById(R.id.mng_assigned_task_edit_task_name);
        edit_task_start_date = v.findViewById(R.id.mng_assigned_task_edit_task_start_date);
        edit_task_due_date = v.findViewById(R.id.mng_assigned_task_edit_task_due_date);
        edit_task_description = v.findViewById(R.id.mng_assigned_task_edit_task_description);
        create_task_btn = v.findViewById(R.id.mng_assigned_task_edit_creates_task);
        ...
        //from ManagerDetailTaskView

        Bundle b = getArguments();
        assert b != null;
        emp_list = (ArrayList<EmployeeDetails>) b.getSerializable("list");
        ...
        final String f_status=t_status;

        real_list = b.getStringArrayList("real_list");

//        Toast.makeText(managerScreen, "Task Status :"+t_status, Toast.LENGTH_SHORT).show();
...
//        task_priority = pev_task_priority;
        ...
        create_task_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if(t_status==null)
                {
                    Toast.makeText(getActivity(), "task status is null", Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();
                }
                else {
                    ...
                    if (is_changed_anything()) {
                        ...
                        try {
                            cmp_ref.getReference().child("Tasks").child("Manager").child(pev_task_name).setValue(task);
                            go_back();
                            progressDialog.dismiss();
                        }catch(Exception e)
                        {
    ...
    public void get_prev_list() {
        ...
        DatabaseReference reference_for_list = FirebaseDatabase.getInstance().getReference("Tasks/Manager");
           ...
           emp_name.setOnFocusChangeListener(new View.OnFocusChangeListener() {
               ...
               public void onFocusChange(View v, boolean hasFocus) {
                   ...
                   if(!got_text.equals("")) {
                       ...
                       emp_list.add(new EmployeeDetails(got_text));
