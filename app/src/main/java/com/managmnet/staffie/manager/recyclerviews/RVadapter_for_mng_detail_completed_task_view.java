...
public class RVadapter_for_mng_detail_completed_task_view extends FirebaseRecyclerAdapter<Files, RVadapter_for_mng_detail_completed_task_view.viewholder> {
    public RVadapter_for_mng_detail_completed_task_view(@NonNull FirebaseRecyclerOptions<Files> options) {
                            ...
                            if(viewholder.File_name==null)
                            {
                                ...
                                storageRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        ...
                                        Query applesQuery = ref.child("Completed Tasks").child("submitted").child("Manager").child(user.getUid()).
    ...
    @NonNull
    @Override
    public RVadapter_for_mng_detail_completed_task_view.viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new RVadapter_for_mng_detail_completed_task_view.viewholder(v);
    }
