...
public class RVadapter_for_mng_emp_completed_task_view extends RecyclerView.Adapter<RVadapter_for_mng_emp_completed_task_view.viewholder>{

    Context context;
    ArrayList<EmployeeDetails> list;
    public RVadapter_for_mng_emp_completed_task_view(Context context, ArrayList<EmployeeDetails> list)
    {
    ...
    @NonNull
    @Override
    public RVadapter_for_mng_emp_completed_task_view.viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        ...
        return new RVadapter_for_mng_emp_completed_task_view.viewholder(v);
    }
