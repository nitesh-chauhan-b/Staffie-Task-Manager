...
public class AdminCreateTaskView extends Fragment {

    Calendar c = Calendar.getInstance();
    EditText start_date, add_member, due_date, task_name, task_desc;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_admin_create_task_view, null);

        task_name = v.findViewById(R.id.adm_task_name);
        start_date = v.findViewById(R.id.adm_task_start_date);
        due_date = v.findViewById(R.id.adm_task_due_date);
        create_task_btn = v.findViewById(R.id.adm_creates_task);
        task_desc = v.findViewById(R.id.adm_task_description);
        ...
        create_task_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(task_name.getText())) {
                    ...
                    database.getReference().child("Tasks").child("Admin").child(Task_name).setValue(task);
                    progressDialog.dismiss();
...
//                    ba.setFabCradleMargin(10);

                    AdminTaskView.getInstance().get_all_data();
...
//                    TabLayout tabLayout = getActivity().findViewById(R.id.admin_tablayout_view);
