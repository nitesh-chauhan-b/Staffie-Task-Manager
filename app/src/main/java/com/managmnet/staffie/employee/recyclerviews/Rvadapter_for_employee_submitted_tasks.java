...
public class Rvadapter_for_employee_submitted_tasks extends FirebaseRecyclerAdapter<Files,Rvadapter_for_employee_submitted_tasks.viewholder> {


    public Rvadapter_for_employee_submitted_tasks(@NonNull FirebaseRecyclerOptions<Files> options) {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        if(item.getItemId()==R.id.remove_file)
                        {
                            ...
                            if(viewholder.File_name==null)
                            {
                                ...
                                StorageReference storageRef = storage.getReference().child("Employee Completed Tasks").child(viewholder.File_name.getText().toString());
                                ...
                                storageRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        ...
                                        Query applesQuery = ref.child("Completed Tasks").child("submitted").child("Employee").child(user.getUid()).
    ...
    @NonNull
    @Override
    public Rvadapter_for_employee_submitted_tasks.viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new Rvadapter_for_employee_submitted_tasks.viewholder(v);
    }
