...
import com.managmnet.staffie.employee.EmployeeDetailCompletedTaskView;
import com.managmnet.staffie.employee.modles.EmployeeDetails;

import java.util.ArrayList;

public class RVadapter_for_completed_task extends RecyclerView.Adapter<RVadapter_for_completed_task.viewholder>{

    Context context;
    ArrayList<EmployeeDetails> list;
    public RVadapter_for_completed_task(Context context, ArrayList<EmployeeDetails> list)
    {
    ...
    public void onBindViewHolder(@NonNull viewholder holder, int position)
    {
        ...
        holder.task_name.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EmployeeDetailCompletedTaskView f = new EmployeeDetailCompletedTaskView();
                f.setArguments(b);
