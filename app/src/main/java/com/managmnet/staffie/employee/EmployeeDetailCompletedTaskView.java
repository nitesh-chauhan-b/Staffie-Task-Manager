...
public class EmployeeDetailCompletedTaskView extends Fragment {
    ImageView back;
    ...
    Rvadapter_for_employee_submitted_tasks adapter;



    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_employee_detail_completed_task_view, null);


        back = v.findViewById(R.id.back_button);
        task_name = v.findViewById(R.id.emp_completed_task_name);
...
//        submit_btn = v.findViewById(R.id.emp_completed_task_undo_submit);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EmployeeCompletedTasks f = new EmployeeCompletedTasks();
...
//                        HashMap<String,String> map = new HashMap<String,String>();
    ...
    public void firebase_files(){
        ...
        adapter = new Rvadapter_for_employee_submitted_tasks(options);
