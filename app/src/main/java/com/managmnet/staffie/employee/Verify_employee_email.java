...
public class Verify_employee_email extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_verify_employee_email, container, false);



        verify_message = v.findViewById(R.id.verify_message);
        verify_message_email = v.findViewById(R.id.verify_message_email);
        continue_login = v.findViewById(R.id.mng_email_continue);
        resend_email = v.findViewById(R.id.mng_resent_link);
        ...
        String admin_name = b.getString("emp_name");
        String admin_mail = b.getString("emp_email");
