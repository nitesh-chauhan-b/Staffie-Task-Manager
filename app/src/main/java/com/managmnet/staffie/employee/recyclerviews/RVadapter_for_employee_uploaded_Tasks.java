...
public class RVadapter_for_employee_uploaded_Tasks extends FirebaseRecyclerAdapter<Files,RVadapter_for_employee_uploaded_Tasks.viewholder> {


    public RVadapter_for_employee_uploaded_Tasks(@NonNull FirebaseRecyclerOptions<Files> options) {
